...
public class NPX {
    ...
    public static final IRI EXAMPLE_NANOPUB = VocabUtils.createIRI(NAMESPACE, "ExampleNanopub");
    ...
    public static final IRI APPROVES_OF = VocabUtils.createIRI(NAMESPACE, "approvesOf");
