...
public class FDOC {
    ...
    public static final IRI FDO_PROFILE = VocabUtils.createIRI(NAMESPACE, "FdoProfile");

    public static final IRI HAS_SHAPE = VocabUtils.createIRI(NAMESPACE, "hasShape");
}
