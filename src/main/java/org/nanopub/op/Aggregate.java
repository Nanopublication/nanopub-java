...
/**
 * This class runs the nanopub aggregation operation.
 */
public class Aggregate extends CliRunner {
    ...
    /**
     * Main method to run the Aggregate operation.
     *
    ...
    /**
     * Creates an instance of the Aggregate class with the given arguments.
     *
     * @param args Command line arguments
