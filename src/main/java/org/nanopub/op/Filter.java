...
/**
 * Command-line utility to filter nanopublications based on URIs or literals.
 */
public class Filter extends CliRunner {
    ...
    /**
     * Main method to run the filter command-line utility.
     *
    ...
    /**
     * Checks if a given RDF value is an example URI.
     *
     * @param v The RDF value to check
     * @return true if the value is an example URI, false otherwise
     */
