...
/**
 * Command-line tool to retrieve and display information about a Nanopub server.
 */
public class GetServerInfo extends CliRunner {
    ...
    /**
     * Main method to run the GetServerInfo command-line tool.
     *
     * @param args Command-line arguments, expected to be server URLs.
     */
