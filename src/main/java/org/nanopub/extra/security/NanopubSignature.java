...
public class NanopubSignature {
	...
	public static final URI SIGNATURE_ELEMENT_URI = new URIImpl("http://purl.org/nanopub/x/NanopubSignatureElement");
	public static final URI HAS_SIGNATURE_ELEMENT_URI = new URIImpl("http://purl.org/nanopub/x/hasSignatureElement");
